...
```tsx filename="DisclosureDemoBasic.tsx" {1,6-13} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
...
```tsx filename="DisclosureDemoRenderProp.tsx" {1,6-19} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
import items from './data/items';
...
```tsx filename="DisclosureDemoWithStyles.tsx" {1,9-16} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
