...
```tsx filename="DisclosureDemoBasic.tsx" {1,9-16} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
...
```tsx filename="DisclosureDemoRenderProp.tsx" {1,9-22} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
...
```tsx filename="DisclosureDemoWithStyles.tsx" {1,10-17} copy showLineNumbers
import Disclosure from '@madeinhaus/disclosure';
