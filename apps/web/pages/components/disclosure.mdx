...
import {
  ...
  DisclosureDemoControlledWithExposedActiveIndex,
...
### Usage as Controlled Accordion With Exposing Active Index

```tsx filename="DisclosureDemoControlledWithExposedActiveIndex.tsx" {1-4,9,12,15-47} copy showLineNumbers
