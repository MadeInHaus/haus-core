...
```tsx
import { getHash } from '@madeinhaus/hooks';
```
...
In this example, we import the `getHash` function from the `@madeinhaus/utils` module and use it to extract the hash portion of a URL.